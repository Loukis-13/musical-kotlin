...
class MusicaServiceImpl(val musicaRespository: MusicalRepository<Musica>): MusicalService<Musica> {
    ...
    override fun searchEntity(id: Int) = ResponseEntity.ok(musicaRespository.findById(id).orElseThrow())
    ...
    override fun deleteEntity(id: Int): ResponseEntity<Void> = musicaRespository.deleteById(id).run {
